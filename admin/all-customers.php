...
<?php  include "header.php"; ?>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td class=""><a href="edit_products.php?edit_product_details=<?=$row['id']?>"><i class="fa-regular fa-pen-to-square text-primary fs-3"></i></a></td>
      <form action="" method="post">
      <td class=""><a href="product_delete.php?delete=<?=$row['id']?>"><i class="fa-solid fa-trash text-danger fs-3"></i></a></td>
      </form>
    </tr>
   <?php
}
